<div class="tengah">
	<h2>Pengumunan Pelanggan & Masyarakat</h2>
</div>
<div class="gambar-atas">
	<img src="<?php echo base_url();?>assets/banner_announcement.jpg"/>
</div>
	...
	while ($row=$artikel->fetch_row()) {
		...
		<div style=\"border:none;border-bottom:1px dotted #ccc;margin-top:10px;padding:2px;border-radius:5px; min-height:150px;\">
			...
			<div style=\"padding:5px;background:#fff;\">
				<b style=\"font-size:150%;\"><span class=\"glyphicon glyphicon-exclamation-sign\"></span> $row[2]</b>
				<br/>
